...
TriangleRender::TriangleRender(const char *vertextPath, const char *fragmentPath)
...
int TriangleRender::setupGL() {
    return m_pImpl->setupGL();
}

void TriangleRender::tearDownGL() {
    m_pImpl->tearDownGL();
}

void TriangleRender::updateWindowSize(int width, int height) {
