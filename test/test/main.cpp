...
public:
    virtual void startup() {
        const char* vertex_shader_path = "../test/vertex.glsl";
        const char* fragment_shader_path = "../test/fragment.glsl";
        const char* tessellation_control_shader_path = "../test/tessellation_control.glsl";
        const char* tessellation_evaluation_shader_path = "../test/tessellation_evaluation.glsl";
